...
SOURCES = \
	__init__.py \
	ncfu_plugin.py ncfu_plugin_dialog.py

PLUGINNAME = ncfu_plugin

PY_FILES = \
	__init__.py \
	ncfu_plugin.py ncfu_plugin_dialog.py

UI_FILES = ncfu_plugin_dialog_base.ui
...
QGISDIR=C:\Users\prrr\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
